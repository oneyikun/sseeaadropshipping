    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="container py-12 max-w-5xl">
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4">一件代发完整流程</h1>
                ...
                <CardHeader>
                  <div className="flex items-start gap-4">
                    <div className={`w-16 h-16 rounded-xl bg-gradient-to-br flex items-center justify-center flex-shrink-0 ${
                      isDisabled ? 'from-gray-400 to-gray-500' : 'from-blue-500 to-blue-600'
                    }`}>
                      ...
                      <ul className="space-y-1 text-sm text-muted-foreground">
                        {step.items.map((item, index) => (
                          <li key={index} className="flex items-start gap-2">
                            <span className={`mt-1 ${isDisabled ? 'text-gray-400' : 'text-blue-600'}`}>•</span>
                            <span>{item}</span>
                          </li>
                        ))}
                      </ul>
